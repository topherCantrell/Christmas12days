...
public class Argument {
    ...
    public String value;   // name=value ... this is the raw "value" part, whatever
    String units;   // name=100Hz ... the is the "HZ" part if numeric and given
                    // * NOTE * Units can only be given to base 10 numbers
    
    public boolean isVariable; // name=V123 ... this is TRUE if value is a variable
                        // and longValue will be "123" part
                        // * NOTE * Variables can only be specified in base 10
    public boolean isVariableOK; // True if V0 - V127
    
    boolean doubleValueOK;  // True if the numeric value parses as a double
    double doubleValue;     // The parsed double value or 0.0
   
    public boolean longValueOK;    // True if the numeric value parses as a long
    public long longValue;         // The parsed long value or 0.0    
    
    public static final String validVariableForm = "V0-V127"; // For error messages
